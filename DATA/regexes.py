...
def generate_regex(input: str, plural=False) -> str:
    char_swaps = {
        ...
        "8": "8Ȣȣ৪੪ଃ８𐌚𝟖𝟠𝟪𝟴𝟾𞣋🯸",
        "9": "9৭੧୨൭ⳊꝮ９𑢬𑣌𑣖𝟗𝟡𝟫𝟵𝟿🯹",
        "a": "a4ÁáÀàĂăẮắẰằẴẵẲẳÂâẤấẦầẪẫẨẩǍǎÅåǺǻÄäǞǟÃãȦȧǠǡĄąĄ́ą́Ą̃ą̃ĀāĀ̀ā̀ẢảȀȁA̋a̋ȂȃẠạẶặẬậḀḁȺⱥꞺꞻᶏẚＡａ!",
...
slurs = [
    ...
    allow_seperators(
        r"\b(?i)[tŤťṪṫŢţṬṭȚțṰṱṮṯŦŧȾⱦƬƭƮʈT̈ẗᵵƫȶ]+[rŔŕŘřṘṙŖŗȐȑȒȓṚṛṜṝṞṟR̃r̃ɌɍꞦꞧⱤɽᵲᶉꭉ]+[aÁáÀàĂăẮắẰằẴẵẲẳÂâẤấẦầẪẫẨẩǍǎÅåǺǻÄäǞǟÃãȦȧǠǡĄąĄ́ą́Ą̃ą̃ĀāĀ̀ā̀ẢảȀȁA̋a̋ȂȃẠạẶặẬậḀḁȺⱥꞺꞻᶏẚＡａ4]+[nŃńǸǹŇňÑñṄṅŅņṆṇṊṋṈṉN̈n̈ƝɲŊŋꞐꞑꞤꞥᵰᶇɳȵꬻꬼИиПпＮｎ]+[nŃńǸǹŇňÑñṄṅŅņṆṇṊṋṈṉN̈n̈ƝɲŊŋꞐꞑꞤꞥᵰᶇɳȵꬻꬼИиПпＮｎ]+([i!|Ííi̇́Ììi̇̀ĬĭÎîǏǐÏïḮḯĨĩi̇̃ĮįĮ́į̇́Į̃į̇̃ĪīĪ̀ī̀ỈỉȈȉI̋i̋ȊȋỊịꞼꞽḬḭƗɨᶖİiIıＩｉ1lĺľļḷḹl̃ḽḻłŀƚꝉⱡɫɬꞎꬷꬸꬹᶅɭȴＬｌ]+[e3ЄєЕеÉéÈèĔĕÊêẾếỀềỄễỂểÊ̄ê̄Ê̌ê̌ĚěËëẼẽĖėĖ́ė́Ė̃ė̃ȨȩḜḝĘęĘ́ę́Ę̃ę̃ĒēḖḗḔḕẺẻȄȅE̋e̋ȆȇẸẹỆệḘḙḚḛɆɇE̩e̩È̩è̩É̩é̩ᶒⱸꬴꬳＥｅ]+|[yÝýỲỳŶŷY̊ẙŸÿỸỹẎẏȲȳỶỷỴỵɎɏƳƴỾỿ]+|[e3ЄєЕеÉéÈèĔĕÊêẾếỀềỄễỂểÊ̄ê̄Ê̌ê̌ĚěËëẼẽĖėĖ́ė́Ė̃ė̃ȨȩḜḝĘęĘ́ę́Ę̃ę̃ĒēḖḗḔḕẺẻȄȅE̋e̋ȆȇẸẹỆệḘḙḚḛɆɇE̩e̩È̩è̩É̩é̩ᶒⱸꬴꬳＥｅ]+[rŔŕŘřṘṙŖŗȐȑȒȓṚṛṜṝṞṟR̃r̃ɌɍꞦꞧⱤɽᵲᶉꭉ]+)[sŚśṤṥŜŝŠšṦṧṠṡŞşṢṣṨṩȘșS̩s̩ꞨꞩⱾȿꟅʂᶊᵴzZŹźŻżŽžẐẑẒẓẔẕƵƶȤȥⱫⱬꝢꝣＺｚ]*\b"
    ),
    allow_seperators(
    ...
    allow_seperators(
        r"\b(?i)[rℝｒŗȓṛṚRᖇṝŔṟɽᚱṘŘŕřᎡℛȑȒƦɌɍᏒṙＲṜℜrȐʀŖṞⱤ]+[eeḜẽȅȇéēËȆḛểĒᴇĚΕḚⴹÈệḙỄЕĔĕÊｅęèҽễếẻℰEỂȄẸẹḝеềＥěȩ3ẾĘḘĖᎬëÉỀỆȨℯėê]*[tȚṯṬťƮƭƬΤтTŧτţŢᴛⲦṪtŤțｔṫТᎢṰＴʈṭŦṱṮ]+[aḀẶÂȀẤḁᴀāẩȁĂǍĄäåÄȺȧầⱥẬǻ!ẰǞâᶏẪAăǠᎪẢǡạȦấẳ4αаẮẨǟÃΑẦǺᗅＡАẵảɑaằÅẴãÀẠàậĀａáắǎąặȂÁȃẲẫẚ]+[rℝｒŗȓṛṚRᖇṝŔṟɽᚱṘŘŕřᎡℛȑȒƦɌɍᏒṙＲṜℜrȐʀŖṞⱤ]+[dժᗞᏧďdɗḋᎠDḊḍƉƊⅮĎĐḓƋＤɖḐⅅƌᗪᴅḑḌḒđｄԀ]+([eeḜẽȅȇéēËȆḛểĒᴇĚΕḚⴹÈệḙỄЕĔĕÊｅęèҽễếẻℰEỂȄẸẹḝеềＥěȩ3ẾĘḘĖᎬëÉỀỆȨℯėê]+[dժᗞᏧďdɗḋᎠDḊḍƉƊⅮĎĐḓƋＤɖḐⅅƌᗪᴅḑḌḒđｄԀ]+)?[sšŜՏṡȘᏕＬSｌＳṩẛsṠŝșßṧᏚṥṨŞśŠЅẞṦṤŚşṢṣzZŹźŻżŽžẐẑẒẓẔẕƵƶȤȥⱫⱬꝢꝣＺｚ]*\b"
    ),
]
...
# tranny + pluralized (double n mandatory to match)
