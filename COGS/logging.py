...
class Logging(commands.Cog):
    ...
    async def _types(self, ctx: commands.Context):
        ...
        TYPES = {
            ...
            "Automod": "Moderation actions generated by the AutoMod.",
    ...
    # 1. set log channel (no more than 20!) (manage Server or manage Bot)
    # 2. view log channels (manage channels)
    # 3. delete log channel (manage Server or manage Bot)
    # 4. auto delete log channels (if the channel was deleted)
